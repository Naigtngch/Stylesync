...
# CORRIGIDO: typo "Mondel" -> "Model"
class ProductDBModel(Product):
    def model_dump(self, *, mode='python', include=None, exclude=None, context=None,
                    by_alias=None, exclude_unset=False, exclude_defaults=False,
                    exclude_none=False, exclude_computed_fields=False, round_trip=False,
        ...
        data = super().model_dump(
            ...
            serialize_as_any=serialize_as_any, polymorphic_serialization=polymorphic_serialization
        )
        # CORRIGIDO: antes assumia que a chave sempre era '_id', o que só é
        # verdade quando by_alias=True. Agora funciona nos dois casos.
        if self.id:
